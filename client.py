...
def get_cred():
    print("\nEnter details: \n")
    username=input("khawadeyshrujan@gmail.com")
    pwd=input("hnqt cllz hfcx kach")
    receiver=input("khawadeyshrujan@gmail.com")
    try:
...
def main():
    server_ip="10.17.16.212"            # Enter server ip address here
